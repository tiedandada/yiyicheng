...
class Goods_order extends Model
{
    ...
    function complateorder(){
    	return $this->leftjoin('user','goods_order.user_id=user.user_id')->field('goods_order.order_sn,goods_order.link_phone,goods_order.order_money,user.user_name,goods_order.link_man,goods_order.add_time')->where('goods_order.order_state','4')->select();
