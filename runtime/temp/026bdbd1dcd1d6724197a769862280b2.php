...
<script type="text/javascript" src="/front/js/jquery-1.8.2.min.js"></script>
<script>
function clearnick(id){
    
     $.get("/index/goods_car/delete_goods",{id:id},function(data){
                    if(data==1){
...
<!--            <td class="car_th" width="140">返还积分</td>-->
          ...
          <tr>
            <td>
            	<div class="c_s_img"><img src="<?php echo htmlentities($v['goods_img']); ?>" width="73" height="73" /></div>
            ...
            <td align="center">
            	<div class="c_num">
                	...
                	<input type="text" value="<?php echo htmlentities($v['goods_num']); ?>" name="" class="car_ipt" />  
                    <input type="button" value="" onclick="addUpdate1(jq(this));" class="car_btn_2" />
                </div>
            </td>
            <td align="center" style="color:#ff4e00;" ><?php echo htmlentities($v['goods_price'] * $v['goods_num']); ?></td>
            <td align="center"><a onclick="clearnick('<?php echo htmlentities($v['goods_id']); ?>')">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
          </tr>
          <?php endforeach; ?>
          ...
          <tr height="70">
            <td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;"><?php echo htmlentities($zj); ?></b></span>
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="/index/index/index"><img src="/front/images/buy1.gif" /></a>&nbsp; &nbsp; <a href="/index/account/confirm_settle"><img src="/front/images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
