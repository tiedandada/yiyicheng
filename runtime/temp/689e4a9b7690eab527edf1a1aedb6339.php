<?php /*a:5:{s:72:"F:\phpServer\wwwroot\yiyicheng\application\index\view\goods\product.html";i:1529994904;s:77:"F:\phpServer\wwwroot\yiyicheng\application\index\view\shop_productlayout.html";i:1529493679;s:93:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\header\shop_product_header2.html";i:1529995724;s:80:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\footer\footer1.html";i:1529493679;s:80:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\footer\footer2.html";i:1529493679;}*/ ?>
...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="/index/usera/user_index">登录</a>&nbsp; <a href="/index/usera/toregister" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="menu_bg">
	<div class="menu">
        ...
        <!--End 商品分类详情 End-->                                                     
    	<ul class="menu_r">   
           <li style="width:70px "><a href="#">首页</a></li>
             
           <li style="width:1px">
               
               
            </li><li style="width:60px"> <a href="#"></a></li>
            <li style="width:1px">  
            </li>
...
<script>
    function ShowDiv_1(show_div,bg_div,id){
            var num = $('#num').val();//获取要加如购物车商品的数量
            $.get("/index/goods_car/rece_good",{id:id,num:num},function(data){
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="<?php echo htmlentities($xq['goods_img'][0]); ?>" title="Images" class="MagicZoom" id="MagicZoom"><img src="<?php echo htmlentities($xq['goods_img'][0]); ?>" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon">
                    <ul>
                        <?php foreach($xq['goods_img'] as $v): ?>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img src="<?php echo htmlentities($v); ?>" tsImgS="<?php echo htmlentities($v); ?>" width="79" height="79" /></li>
        ...
        <div class="pro_des">
        	<div class="des_name">
            	<p><?php echo htmlentities($xq['goods_name']); ?></p>

            </div>
            <div class="des_price">
            	本店价格：<b><?php echo htmlentities($xq['goods_price']); ?></b><br />
            ...
            <div class="des_share">
            	<div class="d_sh">
                    ...
                    <div class="d_sh_bg">
                        <?php foreach($xq['goods_img'] as $v): ?>
                        <a href="#"><img src="<?php echo htmlentities($v); ?>" /></a>
                        <?php endforeach; ?>
                    </div>
                </div>
...
<!--                <span class="fl"><a onclick="ShowDiv_1(<?php echo htmlentities($xq['goods_id']); ?>)" href='javascript:void(0)'><img src="/front/images/j_car.png" /></a></span>-->
                <span class="fl"><a onclick="ShowDiv_1('MyDiv1','fade1','<?php echo htmlentities($xq['goods_id']); ?>')"><img src="/front/images/j_car.png" /></a></span>
            </div>            
        </div>    
        ...
        <div class="l_list">        	
            ...
            <div class="des_border">
                ...
                <div class="des_con" id="p_attribute">
                	...
                	<table border="0" align="center" style="width:100%; font-family:'宋体'; margin:10px auto;" cellspacing="0" cellpadding="0">
                            <tr><td><?php echo htmlentities($xq['goods_property']); ?></td></tr>
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                	<table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="265"><img src="<?php echo htmlentities($xq['goods_img'][0]); ?>" width="206" height="412" /></td>
                        <td>
                        	<b><?php echo htmlentities($xq['goods_name']); ?></b>
                                   <?php echo htmlentities($xq['goods_xq']); ?>
                    ...
                    <p align="center">
                    <?php foreach($xq['goods_img'] as $v): ?>
                    <img src="<?php echo htmlentities($v); ?>" width="746" height="425" /><br /><br />
	            <?php endforeach; ?>		
                    </p>
            ...
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="185" class="jud_bg">
                    	购买过<?php echo htmlentities($xq['goods_name']); ?>在收到商品才可以对该商品发表评论
                    </td>
                ...
                <table border="0" class="jud_list" style="width:100%; margin-top:30px;" cellspacing="0" cellpadding="0">
                   <?php foreach($pl as $k=>$vo): ?> 
                  <tr valign="top">
                    
                    <td width="160"><img src="<?php echo htmlentities($vo['user_img']); ?>" width="20" height="20" align="absmiddle" />&nbsp;<?php echo htmlentities($vo['user_name']); ?></td>

                    <td>
                    	<?php echo htmlentities($vo['comment_con']); ?> <br />
                        <font color="#999999"><?php echo htmlentities($vo['comment_time']); ?></font>
                    </td>
...
<!--                <input type="hidden" value="" >	-->
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                  ...
                  <tr height="50" valign="bottom">
                  	<td>&nbsp;</td>
                    <td><a href="/index/goods_car/buycar" class="b_sure">去购物车结算</a><a href="http://www.xinyiyicheng.com/index/index/index" class="b_buy">继续购物</a></td>
                  </tr>
                </table>
