<?php /*a:6:{s:77:"F:\phpServer\wwwroot\yiyicheng\application\index\view\account\buycar_two.html";i:1530000505;s:72:"F:\phpServer\wwwroot\yiyicheng\application\index\view\buy_carlayout.html";i:1529905001;s:91:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\header\shop_class_header2.html";i:1529905001;s:90:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\header\shop_class_header.html";i:1529979035;s:80:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\footer\footer1.html";i:1529493679;s:80:"F:\phpServer\wwwroot\yiyicheng\application\index\view\public\footer\footer2.html";i:1529493679;}*/ ?>
...
<div class="top">
    ...
    <div class="i_car">
        <div class="car_t"><a href="/index/goods_car/buycar">购物车 </a></div>
...
<!--End Menu End--> 
<form  type="hidden" action="/index/Orderlay/confirm_order" method="post"  >
    <div class="i_bg">  
        ...
        <div class="content mar_20">
            <div class="two_bg">
                    <div class="two_t">
                        <span class="fr"><a href="/index/goods_car/buycar">修改</a></span>商品列表
                    </div>
                <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                    ...
                    <?php foreach($goods_list as $k=>$v): ?>
                        <tr class="car_tr">
                            <td>
                                <div class="c_s_img">
        `                           <img src="<?php echo htmlentities($v['goods_img']); ?>" width="73" height="73" />
                                </div>
                              <?php echo htmlentities($v['goods_name']); ?>
                            </td>
                            <td align="center">颜色：灰色</td>
                            <td align="center"><?php echo htmlentities($v['s']); ?></td>
                            <td align="center"><?php echo htmlentities($v['goods_price']); ?></td>
                            <td align="center" style="color:#ff4e00;"><?php echo htmlentities($v['s'] *$v['goods_price']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
                      <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                          商品总价：<?php echo htmlentities($total_price); ?>
                      </td>
                    </tr>
                </table>
                ...
                <input  name='address_id' value="<?php echo htmlentities($address['address_id']); ?>" type="hidden" />
                <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">

                    <tr>
                        <td class="p_td" width="160">联系人</td>
                        <td width="395"><?php echo htmlentities($address['link_man']); ?></td>
                        <td class="p_td" width="160">用户邮箱</td>
                        <td width="395"><?php echo htmlentities($address['email']); ?></td>
                    </tr>

                    <tr>
                        
                        <td class="p_td">详细地址</td>
                        <td><?php echo htmlentities($address['address_name']); ?></td>
                        <td class="p_td">联系电话</td>
                        <td><?php echo htmlentities($address['link_phone']); ?></td>
                    </tr>
                ...
                <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                  ...
                  <tr valign="top">
                    <td align="right" style="padding-right:0;"><b style="font-size:14px;">订单留言备注：</b></td>
                ...
                <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right">
                        ...
                        商品总价: <font color="#ff4e00"><?php echo htmlentities($total_price); ?></font>  + 配送费用: <font color="#ff4e00">￥15.00</font>
                    </td>
                  </tr>
                  <tr height="70">
                    <td align="right">
                            <b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;"><?php echo htmlentities($total_price+15); ?></span></b>
                    </td>
                  </tr>
                  <tr height="70">
                      <td align="right"><button><img src="/front/images/btn_sure.gif" /></button></td>
                  </tr>
                </table>
